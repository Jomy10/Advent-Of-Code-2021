...
function getRating(data, type) {
    ...
    console.log(type, nums[0]);
	return parseInt(nums[0], 2)
}

function main() {
	const data = fs.readFileSync('/Users/jonaseveraert/Documents/IntelliJ/projects/advent_of_code/submarine/src/inputs/3.txt').toString().split('\n');
